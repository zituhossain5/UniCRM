...
export const AUTOMATION_EVENT_MAP = {
  ...
  'deal.created': { entityType: 'DEAL', triggerType: 'DEAL_CREATED' },
  'deal.stage_changed': { entityType: 'DEAL', triggerType: 'DEAL_STAGE_CHANGED' },
  'deal.owner_changed': { entityType: 'DEAL', triggerType: 'DEAL_OWNER_CHANGED' },
  'deal.won': { entityType: 'DEAL', triggerType: 'DEAL_WON' },
  'deal.lost': { entityType: 'DEAL', triggerType: 'DEAL_LOST' },
